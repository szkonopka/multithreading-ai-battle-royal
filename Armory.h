...
public:
  Armory()
  {
    sniper = new Weapon(1500.0f, 11.0f, 1000, 3, 1, weaponId++, "sniper");
    shotgun = new Weapon(580.0f, 15.0f, 800, 4, 1, weaponId++, "shotgun");
    pistol = new Weapon(800.0f, 8.0f, 300, 6, 1, weaponId++, "pistol");
